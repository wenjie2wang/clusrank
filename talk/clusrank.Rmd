...
- Modeled after the base function \texttt{wilcox}
...
$\delta_{ij} = 0$ if $X_{ij}$ is in group $2$.
    ...
    + $g$: the cluster size (for all clusters, for ease of presentation only)
...
## Illustration: Two Within-Cluster Correlation Structure

...
* Available implementations: \texttt{wilcox.test} in R package \textbf{stats}, \texttt{PROC NPAR1WAY} in SAS, \texttt{ranksum/signrank} in Stata, StatXact and etc.  
...
* Some existing software for clustered data
    + R package \texttt{coin}
    + R package \texttt{ClusterRankTest}: @Dutt:Datt:clus:2016, @Dutt:Datt:rank:2016
    + Stata function \texttt{cluswilcox} 

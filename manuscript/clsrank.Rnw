...
observations are independent, however, this is also an 
assumption which is violated quite often in practice. 
E.g., in the study of human eyes, each person is the unit of 
randomization, whereas the data is collected from both eyes,
therefore we sould expect high correlation between the 

### 1. R code from vignette source 'clusrank.Rnw'
...
### 2. R code for simulation tables in 'clusrank.Rnw'
...
rs.b.a.11.2.sub[1, 1:2] <- simpower(4000, 0.05, FALSE, 20, 2, 0, c(0.1, 0.1), ar1, 0, FALSE)
rs.b.a.11.2.sub[1, 3:4] <- simpower(4000, 0.05, FALSE, 20, 2, 0.2, c(0.1, 0.1), ar1, 0, FALSE)
rs.b.a.11.2.sub[1, 5:6] <- simpower(4000, 0.05, FALSE, 20, 2, 0.5, c(0.1, 0.1), ar1, 0, FALSE)
rs.b.a.11.2.sub[2, 1:2] <- simpower(4000, 0.05, FALSE, 50, 2, 0, c(0.1, 0.1), ar1, 0, FALSE)
rs.b.a.11.2.sub[2, 3:4] <- simpower(4000, 0.05, FALSE, 50, 2, 0.2, c(0.1, 0.1), ar1, 0, FALSE)
rs.b.a.11.2.sub[2, 5:6] <- simpower(4000, 0.05, FALSE, 50, 2, 0.5, c(0.1, 0.1), ar1, 0, FALSE)
...
rs.b.a.55.2.sub[1, 1:2] <- simpower(4000, 0.05, FALSE, 20, 2, 0, c(0.5, 0.5), ar1, 0, FALSE)
rs.b.a.55.2.sub[1, 3:4] <- simpower(4000, 0.05, FALSE, 20, 2, 0.2, c(0.5, 0.5), ar1, 0, FALSE)
rs.b.a.55.2.sub[1, 5:6] <- simpower(4000, 0.05, FALSE, 20, 2, 0.5, c(0.5, 0.5), ar1, 0, FALSE)
rs.b.a.55.2.sub[2, 1:2] <- simpower(4000, 0.05, FALSE, 50, 2, 0, c(0.5, 0.5), ar1, 0, FALSE)
rs.b.a.55.2.sub[2, 3:4] <- simpower(4000, 0.05, FALSE, 50, 2, 0.2, c(0.5, 0.5), ar1, 0, FALSE)
rs.b.a.55.2.sub[2, 5:6] <- simpower(4000, 0.05, FALSE, 50, 2, 0.5, c(0.5, 0.5), ar1, 0, FALSE)
...
rs.b.a.19.2.sub[1, 1:2] <- simpower(4000, 0.05, FALSE, 20, 2, 0, c(-0.1, 0.9), ar1, 0, FALSE)
rs.b.a.19.2.sub[1, 3:4] <- simpower(4000, 0.05, FALSE, 20, 2, 0.2, c(-0.1, 0.9), ar1, 0, FALSE)
rs.b.a.19.2.sub[1, 5:6] <- simpower(4000, 0.05, FALSE, 20, 2, 0.5, c(-0.1, 0.9), ar1, 0, FALSE)
rs.b.a.19.2.sub[2, 1:2] <- simpower(4000, 0.05, FALSE, 50, 2, 0, c(-0.1, 0.9), ar1, 0, FALSE)
rs.b.a.19.2.sub[2, 3:4] <- simpower(4000, 0.05, FALSE, 50, 2, 0.2, c(-0.1, 0.9), ar1, 0, FALSE)
rs.b.a.19.2.sub[2, 5:6] <- simpower(4000, 0.05, FALSE, 50, 2, 0.5, c(-0.1, 0.9), ar1, 0, FALSE)
...
rs.b.a.11.5.sub[1, 1:2] <- simpower(4000, 0.05, FALSE, 20, 5, 0, c(0.1, 0.1), ar1, 0, FALSE)
rs.b.a.11.5.sub[1, 3:4] <- simpower(4000, 0.05, FALSE, 20, 5, 0.2, c(0.1, 0.1), ar1, 0, FALSE)
rs.b.a.11.5.sub[1, 5:6] <- simpower(4000, 0.05, FALSE, 20, 5, 0.5, c(0.1, 0.1), ar1, 0, FALSE)
rs.b.a.11.5.sub[2, 1:2] <- simpower(4000, 0.05, FALSE, 50, 5, 0, c(0.1, 0.1), ar1, 0, FALSE)
rs.b.a.11.5.sub[2, 3:4] <- simpower(4000, 0.05, FALSE, 50, 5, 0.2, c(0.1, 0.1), ar1, 0, FALSE)
rs.b.a.11.5.sub[2, 5:6] <- simpower(4000, 0.05, FALSE, 50, 5, 0.5, c(0.1, 0.1), ar1, 0, FALSE)
...
rs.b.a.55.5.sub[1, 1:2] <- simpower(4000, 0.05, FALSE, 20, 5, 0, c(0.5, 0.5), ar1, 0, FALSE)
rs.b.a.55.5.sub[1, 3:4] <- simpower(4000, 0.05, FALSE, 20, 5, 0.2, c(0.5, 0.5), ar1, 0, FALSE)
rs.b.a.55.5.sub[1, 5:6] <- simpower(4000, 0.05, FALSE, 20, 5, 0.5, c(0.5, 0.5), ar1, 0, FALSE)
rs.b.a.55.5.sub[2, 1:2] <- simpower(4000, 0.05, FALSE, 50, 5, 0, c(0.5, 0.5), ar1, 0, FALSE)
rs.b.a.55.5.sub[2, 3:4] <- simpower(4000, 0.05, FALSE, 50, 5, 0.2, c(0.5, 0.5), ar1, 0, FALSE)
rs.b.a.55.5.sub[2, 5:6] <- simpower(4000, 0.05, FALSE, 50, 5, 0.5, c(0.5, 0.5), ar1, 0, FALSE)
...
rs.b.a.19.5.sub[1, 1:2] <- simpower(4000, 0.05, FALSE, 20, 5, 0, c(-0.1, 0.9), ar1, 0, FALSE)
rs.b.a.19.5.sub[1, 3:4] <- simpower(4000, 0.05, FALSE, 20, 5, 0.2, c(-0.1, 0.9), ar1, 0, FALSE)
rs.b.a.19.5.sub[1, 5:6] <- simpower(4000, 0.05, FALSE, 20, 5, 0.5, c(-0.1, 0.9), ar1, 0, FALSE)
rs.b.a.19.5.sub[2, 1:2] <- simpower(4000, 0.05, FALSE, 50, 5, 0, c(-0.1, 0.9), ar1, 0, FALSE)
rs.b.a.19.5.sub[2, 3:4] <- simpower(4000, 0.05, FALSE, 50, 5, 0.2, c(-0.1, 0.9), ar1, 0, FALSE)
rs.b.a.19.5.sub[2, 5:6] <- simpower(4000, 0.05, FALSE, 50, 5, 0.5, c(-0.1, 0.9), ar1, 0, FALSE)
...
rs.ub.a.11.10.sub[1, 1:2] <- simpower(4000, 0.05, FALSE, 20, 10, 0, c(0.1, 0.1), ar1, 0.5, FALSE)
rs.ub.a.11.10.sub[1, 3:4] <- simpower(4000, 0.05, FALSE, 20, 10, 0.2, c(0.1, 0.1), ar1, 0.5, FALSE)
rs.ub.a.11.10.sub[1, 5:6] <- simpower(4000, 0.05, FALSE, 20, 10, 0.5, c(0.1, 0.1), ar1, 0.5, FALSE)
rs.ub.a.11.10.sub[2, 1:2] <- simpower(4000, 0.05, FALSE, 50, 10, 0, c(0.1, 0.1), ar1, 0.5, FALSE)
rs.ub.a.11.10.sub[2, 3:4] <- simpower(4000, 0.05, FALSE, 50, 10, 0.2, c(0.1, 0.1), ar1, 0.5, FALSE)
rs.ub.a.11.10.sub[2, 5:6] <- simpower(4000, 0.05, FALSE, 50, 10, 0.5, c(0.1, 0.1), ar1, 0.5, FALSE)
####################################################################
### Rank sum, sub-unit grouping ar1, rho = 0.5, 0.5, clus size
### = 10, delta = 0, 0.2, 0.5, grpsize = 20, 50, unbalanced data,
### missingrate = 0.5
...
rs.ub.a.55.10.sub[1, 1:2] <- simpower(4000, 0.05, FALSE, 20, 10, 0, c(0.5, 0.5), ar1, 0.5, FALSE)
rs.ub.a.55.10.sub[1, 3:4] <- simpower(4000, 0.05, FALSE, 20, 10, 0.2, c(0.5, 0.5), ar1, 0.5, FALSE)
rs.ub.a.55.10.sub[1, 5:6] <- simpower(4000, 0.05, FALSE, 20, 10, 0.5, c(0.5, 0.5), ar1, 0.5, FALSE)
rs.ub.a.55.10.sub[2, 1:2] <- simpower(4000, 0.05, FALSE, 50, 10, 0, c(0.5, 0.5), ar1, 0.5, FALSE)
rs.ub.a.55.10.sub[2, 3:4] <- simpower(4000, 0.05, FALSE, 50, 10, 0.2, c(0.5, 0.5), ar1, 0.5, FALSE)
rs.ub.a.55.10.sub[2, 5:6] <- simpower(4000, 0.05, FALSE, 50, 10, 0.5, c(0.5, 0.5), ar1, 0.5, FALSE)
####################################################################
### Rank sum, sub-unit grouping ar1, rho = -0.1, 0.9, clus size
### = 10, delta = 0, 0.2, 0.5, grpsize = 20, 50, unbalanced data,
### missingrate = 0.5
...
rs.ub.a.19.10.sub[1, 1:2] <- simpower(4000, 0.05, FALSE, 20, 10, 0, c(-0.1, 0.9), ar1, 0.5, FALSE)
rs.ub.a.19.10.sub[1, 3:4] <- simpower(4000, 0.05, FALSE, 20, 10, 0.2, c(-0.1, 0.9), ar1, 0.5, FALSE)
rs.ub.a.19.10.sub[1, 5:6] <- simpower(4000, 0.05, FALSE, 20, 10, 0.5, c(-0.1, 0.9), ar1, 0.5, FALSE)
rs.ub.a.19.10.sub[2, 1:2] <- simpower(4000, 0.05, FALSE, 50, 10, 0, c(-0.1, 0.9), ar1, 0.5, FALSE)
rs.ub.a.19.10.sub[2, 3:4] <- simpower(4000, 0.05, FALSE, 50, 10, 0.2, c(-0.1, 0.9), ar1, 0.5, FALSE)
rs.ub.a.19.10.sub[2, 5:6] <- simpower(4000, 0.05, FALSE, 50, 10, 0.5,
                                      c(-0.1, 0.9), ar1, 0.5, FALSE)

...
%%%%%%%%%%%%%%%%%%%%%%%%%% Above are simulation for ranksum ex, cluster level
...
%%%%%%%%%%%%%%%%%%%%%%%%% Below are simulation for ranksum ex, subunit level
...
%%%%%%%%%%%%%%% Above are simulation for ranksum ex, subunit level


<<rs-b-ex-rho11-csize2-sub, echo = FALSE, eval = TRUE>>=
...
<<rs-b-ex-rho55-csize2-sub, echo = FALSE, eval = TRUE>>=
...
<<rs-b-ex-rho19-csize2-sub, echo = FALSE, eval = TRUE>>=
...
<<rs-b-ex-rho11-csize5-sub, echo = FALSE, eval = TRUE>>=
...
<<rs-b-ex-rho55-csize5-sub, echo = FALSE, eval = TRUE>>=
...
<<rs-b-ex-rho19-csize5-sub, echo = FALSE, eval = TRUE>>=
...
<<rs-ub-ex-rho11-csize10-sub, echo = FALSE, eval = TRUE>>=
...
<<rs-ub-ex-rho55-csize10-sub, echo = FALSE, eval = TRUE>>=
...
<<rs-ub-ex-rho19-csize10-sub, echo = FALSE, eval = TRUE>>=
...
<<sr-b-ex-rho1-csize2, echo = FALSE, eval = TRUE>>=
...
<<sr-b-ex-rho5-csize2, echo = FALSE, eval = TRUE>>=
...
<<sr-b-ex-rho9-csize2, echo = FALSE, eval = TRUE>>=
...
<<sr-b-ex-rho1-csize10, echo = FALSE, eval = TRUE>>=
...
<<sr-b-ex-rho5-csize10, echo = FALSE, eval = TRUE>>=
...
<<sr-b-ex-rho9-csize10, echo = FALSE, eval = TRUE>>=
...
<<sr-ub-ex-rho1-csize5, echo = FALSE, eval = TRUE>>=
...
<<sr-ub-ex-rho5-csize5, echo = FALSE, eval = TRUE>>=
...
<<sr-ub-ex-rho9-csize5, echo = FALSE, eval = TRUE>>=
...
<<sr-ub-ex-rho1-csize10, echo = FALSE, eval = TRUE>>=
...
<<sr-ub-ex-rho5-csize10, echo = FALSE, eval = TRUE>>=
...
<<sr-ub-ex-rho9-csize10, echo = FALSE, eval = TRUE>>=
...
<<rs-b-ar1-rho11-csize2-sub, echo = FALSE, eval = TRUE>>=
rs.b.a.11.2 <- matrix(0, 3, 6)
...
<<rs-b-ar1-rho55-csize2-sub, echo = FALSE, eval = TRUE>>=
rs.b.a.55.2 <- matrix(0, 3, 6)
...
<<rs-b-ar1-rho19-csize2-sub, echo = FALSE, eval = TRUE>>=
rs.b.a.19.2 <- matrix(0, 3, 6)
...
<<rs-b-ar1-rho11-csize5-sub, echo = FALSE, eval = TRUE>>=
rs.b.a.11.5 <- matrix(0, 3, 6)
...
<<rs-b-ar1-rho55-csize5-sub, echo = FALSE, eval = TRUE>>=
rs.b.a.55.5 <- matrix(0, 3, 6)
...
<<rs-b-ar1-rho19-csize5-sub, echo = FALSE, eval = TRUE>>=
rs.b.a.19.5 <- matrix(0, 3, 6)
...
<<rs-ub-ar1-rho11-csize10-sub, echo = FALSE, eval = TRUE>>=
rs.ub.a.11.10 <- matrix(0, 3, 6)
...
<<rs-ub-ar1-rho55-csize10-sub, echo = FALSE, eval = TRUE>>=
rs.ub.a.55.10 <- matrix(0, 3, 6)
...
<<rs-ub-ar1-rho19-csize10-sub, echo = FALSE, eval = TRUE>>=
rs.ub.a.19.10 <- matrix(0, 3, 6)
...
%%%%%%%%%%%%%%% Above are simulation for ranksum ar1, subunit level
...
%%%%%%%%%%%%%% Below are simulation for signrank ar1
...
<<sr-b-ar1-rho1-csize2, echo = FALSE, eval = TRUE>>=
...
<<sr-b-ar1-rho5-csize2, echo = FALSE, eval = TRUE>>=
...
<<sr-b-ar1-rho9-csize2, echo = FALSE, eval = TRUE>>=
...
<<sr-b-ar1-rho1-csize10, echo = FALSE, eval = TRUE>>=
...
<<sr-b-ar1-rho5-csize10, echo = FALSE, eval = TRUE>>=
...
<<sr-b-ar1-rho9-csize10, echo = FALSE, eval = TRUE>>=
...
<<sr-ub-ar1-rho1-csize5, echo = FALSE, eval = TRUE>>=
...
<<sr-ub-ar1-rho5-csize5, echo = FALSE, eval = TRUE>>=
...
<<sr-ub-ar1-rho9-csize5, echo = FALSE, eval = TRUE>>=
...
<<sr-ub-ar1-rho1-csize10, echo = FALSE, eval = TRUE>>=
...
<<sr-ub-ar1-rho5-csize10, echo = FALSE, eval = TRUE>>=
...
<<sr-ub-ar1-rho9-csize10, echo = FALSE, eval = TRUE>>=
...
%%%%%%%%%%%%%%%%%%% Above is simulation for signed rank test, ex.





<<rs-ex-tab, echo = FALSE, eval = TRUE, results = 'asis'>>=
...
sum.tab.rs.e <- xtable(sum.tab.rs.e, digits = 1)
print(sum.tab.rs.e)
@


<<rs-ar1-tab, echo = FALSE, eval = TRUE, results = 'asis'>>=
...
sum.tab.rs.a <- xtable(sum.tab.rs.a, digits = 1)
print(sum.tab.rs.a)
@
...
sum.tab.sr.e <- xtable(sum.tab.sr.e, digits = 1)
...
\sqrt{4000} = 0.032$, therefore we state that there is a significant
...
\sqrt{4000} = 0.012$, therefore we state that there is a significant

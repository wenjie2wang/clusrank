...
<<rs-b-ex-rho11-csize2, echo = FALSE, eval = TRUE>>=
rs.b.e.11.2 <- rep(0, 6)
rs.b.e.11.2[1:2] <- simpower(1000, 0.05, FALSE, 20, 2, 0, c(0.1, 0.1), ex, 0)
rs.b.e.11.2[3:4] <- simpower(1000, 0.05, FALSE, 20, 2, 0.2, c(0.1, 0.1), ex, 0)
rs.b.e.11.2[5:6] <- simpower(1000, 0.05, FALSE, 20, 2, 0.5, c(0.1, 0.1), ex, 0)
@


<<rs-b-ex-rho55-csize2, echo = FALSE, eval = TRUE>>=
rs.b.e.55.2 <- rep(0, 6)
rs.b.e.55.2[1:2] <- simpower(1000, 0.05, FALSE, 20, 2, 0, c(0.5, 0.5), ex, 0)
rs.b.e.55.2[3:4] <- simpower(1000, 0.05, FALSE, 20, 2, 0.2, c(0.5, 0.5), ex, 0)
rs.b.e.55.2[5:6] <- simpower(1000, 0.05, FALSE, 20, 2, 0.5, c(0.5, 0.5), ex, 0)
@

<<rs-b-ex-rho19-csize2, echo = FALSE, eval = TRUE>>=
rs.b.e.19.2 <- rep(0, 6)
rs.b.e.19.2[1:2] <- simpower(1000, 0.05, FALSE, 20, 2, 0, c(-0.1, 0.9), ex, 0)
rs.b.e.19.2[3:4] <- simpower(1000, 0.05, FALSE, 20, 2, 0.2, c(-0.1, 0.9), ex, 0)
rs.b.e.19.2[5:6] <- simpower(1000, 0.05, FALSE, 20, 2, 0.5, c(-0.1, 0.9), ex, 0)
@
...
<<rs-b-ex-rho11-csize5, echo = FALSE, eval = TRUE>>=
rs.b.e.11.5 <- rep(0, 6)
rs.b.e.11.5[1:2] <- simpower(1000, 0.05, FALSE, 20, 5, 0, c(0.1, 0.1), ex, 0)
rs.b.e.11.5[3:4] <- simpower(1000, 0.05, FALSE, 20, 5, 0.2, c(0.1, 0.1), ex, 0)
rs.b.e.11.5[5:6] <- simpower(1000, 0.05, FALSE, 20, 5, 0.5, c(0.1, 0.1), ex, 0)
@


<<rs-b-ex-rho55-csize5, echo = FALSE, eval = TRUE>>=
rs.b.e.55.5 <- rep(0, 6)
rs.b.e.55.5[1:2] <- simpower(1000, 0.05, FALSE, 20, 5, 0, c(0.5, 0.5), ex, 0)
rs.b.e.55.5[3:4] <- simpower(1000, 0.05, FALSE, 20, 5, 0.2, c(0.5, 0.5), ex, 0)
rs.b.e.55.5[5:6] <- simpower(1000, 0.05, FALSE, 20, 5, 0.5, c(0.5, 0.5), ex, 0)
@

<<rs-b-ex-rho19-csize5, echo = FALSE, eval = TRUE>>=
rs.b.e.19.5 <- rep(0, 6)
rs.b.e.19.5[1:2] <- simpower(1000, 0.05, FALSE, 20, 5, 0, c(-0.1, 0.9), ex, 0)
rs.b.e.19.5[3:4] <- simpower(1000, 0.05, FALSE, 20, 5, 0.2, c(-0.1, 0.9), ex, 0)
rs.b.e.19.5[5:6] <- simpower(1000, 0.05, FALSE, 20, 5, 0.5, c(-0.1, 0.9), ex, 0)
@
...
<<rs-ub-ex-rho11-csize10, echo = FALSE, eval = TRUE>>=
rs.ub.e.11.10 <- rep(0, 6)
rs.ub.e.11.10[1:2] <- simpower(1000, 0.05, FALSE, 20, 10, 0, c(0.1, 0.1), ex, 0.5)
rs.ub.e.11.10[3:4] <- simpower(1000, 0.05, FALSE, 20, 10, 0.2, c(0.1, 0.1), ex, 0.5)
rs.ub.e.11.10[5:6] <- simpower(1000, 0.05, FALSE, 20, 10, 0.5, c(0.1, 0.1), ex, 0.5)
@


<<rs-ub-ex-rho55-csize10, echo = FALSE, eval = TRUE>>=
rs.ub.e.55.10 <- rep(0, 6)
rs.ub.e.55.10[1:2] <- simpower(1000, 0.05, FALSE, 20, 10, 0, c(0.5, 0.5), ex, 0.5)
rs.ub.e.55.10[3:4] <- simpower(1000, 0.05, FALSE, 20, 10, 0.2, c(0.5, 0.5), ex, 0.5)
rs.ub.e.55.10[5:6] <- simpower(1000, 0.05, FALSE, 20, 10, 0.5, c(0.5, 0.5), ex, 0.5)
@

<<rs-ub-ex-rho19-csize10, echo = FALSE, eval = TRUE>>=
rs.ub.e.19.10 <- rep(0, 6)
rs.ub.e.19.10[1:2] <- simpower(1000, 0.05, FALSE, 20, 10, 0, c(-0.1, 0.9), ex, 0.5)
rs.ub.e.19.10[3:4] <- simpower(1000, 0.05, FALSE, 20, 10, 0.2, c(-0.1, 0.9), ex, 0.5)
rs.ub.e.19.10[5:6] <- simpower(1000, 0.05, FALSE, 20, 10, 0.5, c(-0.1, 0.9), ex, 0.5)
@
...
<<rs-b-ar1-rho11-csize2, echo = FALSE, eval = TRUE>>=
rs.b.a.11.2 <- rep(0, 6)
rs.b.a.11.2[1:2] <- simpower(1000, 0.05, FALSE, 20, 2, 0, c(0.1, 0.1), ar1, 0)
rs.b.a.11.2[3:4] <- simpower(1000, 0.05, FALSE, 20, 2, 0.2, c(0.1, 0.1), ar1, 0)
rs.b.a.11.2[5:6] <- simpower(1000, 0.05, FALSE, 20, 2, 0.5, c(0.1, 0.1), ar1, 0)
@


<<rs-b-ar1-rho55-csize2, echo = FALSE, eval = TRUE>>=
rs.b.a.55.2 <- rep(0, 6)
rs.b.a.55.2[1:2] <- simpower(1000, 0.05, FALSE, 20, 2, 0, c(0.5, 0.5), ar1, 0)
rs.b.a.55.2[3:4] <- simpower(1000, 0.05, FALSE, 20, 2, 0.2, c(0.5, 0.5), ar1, 0)
rs.b.a.55.2[5:6] <- simpower(1000, 0.05, FALSE, 20, 2, 0.5, c(0.5, 0.5), ar1, 0)
@

<<rs-b-ar1-rho19-csize2, echo = FALSE, eval = TRUE>>=
rs.b.a.19.2 <- rep(0, 6)
rs.b.a.19.2[1:2] <- simpower(1000, 0.05, FALSE, 20, 2, 0, c(-0.1, 0.9), ar1, 0)
rs.b.a.19.2[3:4] <- simpower(1000, 0.05, FALSE, 20, 2, 0.2, c(-0.1, 0.9), ar1, 0)
rs.b.a.19.2[5:6] <- simpower(1000, 0.05, FALSE, 20, 2, 0.5, c(-0.1, 0.9), ar1, 0)
@
...
<<rs-b-ar1-rho11-csize5, echo = FALSE, eval = TRUE>>=
rs.b.a.11.5 <- rep(0, 6)
rs.b.a.11.5[1:2] <- simpower(1000, 0.05, FALSE, 20, 5, 0, c(0.1, 0.1), ar1, 0)
rs.b.a.11.5[3:4] <- simpower(1000, 0.05, FALSE, 20, 5, 0.2, c(0.1, 0.1), ar1, 0)
rs.b.a.11.5[5:6] <- simpower(1000, 0.05, FALSE, 20, 5, 0.5, c(0.1, 0.1), ar1, 0)
@


<<rs-b-ar1-rho55-csize5, echo = FALSE, eval = TRUE>>=
rs.b.a.55.5 <- rep(0, 6)
rs.b.a.55.5[1:2] <- simpower(1000, 0.05, FALSE, 20, 5, 0, c(0.5, 0.5), ar1, 0)
rs.b.a.55.5[3:4] <- simpower(1000, 0.05, FALSE, 20, 5, 0.2, c(0.5, 0.5), ar1, 0)
rs.b.a.55.5[5:6] <- simpower(1000, 0.05, FALSE, 20, 5, 0.5, c(0.5, 0.5), ar1, 0)
@

<<rs-b-ar1-rho19-csize5, echo = FALSE, eval = TRUE>>=
rs.b.a.19.5 <- rep(0, 6)
rs.b.a.19.5[1:2] <- simpower(1000, 0.05, FALSE, 20, 5, 0, c(-0.1, 0.9), ar1, 0)
rs.b.a.19.5[3:4] <- simpower(1000, 0.05, FALSE, 20, 5, 0.2, c(-0.1, 0.9), ar1, 0)
rs.b.a.19.5[5:6] <- simpower(1000, 0.05, FALSE, 20, 5, 0.5, c(-0.1, 0.9), ar1, 0)
@
...
<<rs-ub-ar1-rho11-csize10, echo = FALSE, eval = TRUE>>=
rs.ub.a.11.10 <- rep(0, 6)
rs.ub.a.11.10[1:2] <- simpower(1000, 0.05, FALSE, 20, 10, 0, c(0.1, 0.1), ar1, 0.5)
rs.ub.a.11.10[3:4] <- simpower(1000, 0.05, FALSE, 20, 10, 0.2, c(0.1, 0.1), ar1, 0.5)
rs.ub.a.11.10[5:6] <- simpower(1000, 0.05, FALSE, 20, 10, 0.5, c(0.1, 0.1), ar1, 0.5)
@


<<rs-ub-ar1-rho55-csize10, echo = FALSE, eval = TRUE>>=
rs.ub.a.55.10 <- rep(0, 6)
rs.ub.a.55.10[1:2] <- simpower(1000, 0.05, FALSE, 20, 10, 0, c(0.5, 0.5), ar1, 0.5)
rs.ub.a.55.10[3:4] <- simpower(1000, 0.05, FALSE, 20, 10, 0.2, c(0.5, 0.5), ar1, 0.5)
rs.ub.a.55.10[5:6] <- simpower(1000, 0.05, FALSE, 20, 10, 0.5, c(0.5, 0.5), ar1, 0.5)
@

<<rs-ub-ar1-rho19-csize10, echo = FALSE, eval = TRUE>>=
rs.ub.a.19.10 <- rep(0, 6)
rs.ub.a.19.10[1:2] <- simpower(1000, 0.05, FALSE, 20, 10, 0, c(-0.1, 0.9), ar1, 0.5)
rs.ub.a.19.10[3:4] <- simpower(1000, 0.05, FALSE, 20, 10, 0.2, c(-0.1, 0.9), ar1, 0.5)
rs.ub.a.19.10[5:6] <- simpower(1000, 0.05, FALSE, 20, 10, 0.5, c(-0.1, 0.9), ar1, 0.5)
@

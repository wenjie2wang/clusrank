...
datgen.sr <- function(nclus, maxclsize, delta = 0.,
    ...
    Sigma1 <- cor(maxclsize, rho[1])
    Sigma2 <- cor(maxclsize, rho[2])
    x <- t(rmvnorm(nclus, sigma = Sigma1))
    y <- t(rmvnorm(nclus, sigma = Sigma2))
    x <- c(x, y) + delta  
    x <- sign(x) * exp(abs(x))
    cid <- rep(1:(2*nclus), each = maxclsize)
...
\begin{table}[tbp]
\centering
\caption{Empirical rejection rate comparisons for RGL and DS clustered rank-sum test, nominal level $5\%$, $N = 40$ clusters, $M$ is the maximum cluster size, $1000$ simulations for each combination.}
...
&&&&& \multicolumn{2}{c}{$\delta = 0$} & \multicolumn{2}{c}{$\delta = 0.3$} & \multicolumn{2}{c}{$\delta = 0.6$} \\
  ...
  Design & Corr. str. & $\rho$ & M & Missing rate & RGL & DS & RGL & DS & RGL & DS \\

  \midrule
1 & ex & 0.1 & 5 & 1 &  0.05 & 0.05 & 0.43 & 0.38 & 0.89 & 0.86 \\ 

  2 & & & 5 & 0.5 & 0.05 & 0.04 & 0.21 & 0.19 & 0.55 & 0.50 \\ 
  3 & & & 10 & 0.25 & 0.05 & 0.05 & 0.20 & 0.19 & 0.50 & 0.48 \\ 
  4 & & 0.9 & 5 & 1 & 0.05 & 0.06 & 0.51 & 0.42 & 0.91 & 0.82 \\ 
  5 & & & 5 & 0.5 & 0.04 & 0.05 & 0.29 & 0.18 & 0.62 & 0.47 \\ 
  
  6 & & & 10 & 0.25 & 0.04 & 0.04 & 0.30 & 0.19 & 0.65 & 0.44 \\ 
  7 & ar1 & 0.1 & 5 & 1 &  0.05 & 0.05 & 0.44 & 0.41 & 0.89 & 0.87 \\
  8 & & & 5 & 0.5 &  0.04 & 0.05 & 0.20 & 0.20 & 0.56 & 0.51 \\ 
  9 & & & 10 & 0.25 &  0.05 & 0.06 & 0.20 & 0.20 & 0.53 & 0.51 \\ 
  10 & & 0.9 & 5 & 1 & 0.05 & 0.04 & 0.50 & 0.37 & 0.89 & 0.80 \\ 
 
  11 & & & 5 & 0.5 & 0.04 & 0.05 & 0.26 & 0.18 & 0.64 & 0.48 \\ 

  12 & & & 10 & 0.25 &  0.05 & 0.05 & 0.28 & 0.18 & 0.59 & 0.49 \\ 
 \bottomrule
\end{tabular}
\label{tab:rs}
\end{table}

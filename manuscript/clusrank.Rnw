...
Implementations of the Wilcoxon rank-sum and signed-rank tests for
...
\code{wilcox.test}. The \code{exact} is an integer indicating which
one of the three types of the test is using: the asymptotic test
(\code{exact = 0}), the exact test (\code{exact = 1}) and the permutation
test (with \code{exact} set as an integer greater than 1 which is taken
as the size of the random permutation).
The exact test (\code{exact = 1}) is only available for the RGL
clustered rank-sum test with cluster-level grouping and the RGL
clustered signed-rank test, nevertheless random permutation test is available
for tests for which no exact test is provided due to the computational
complexity. Since the exact test is computationally very
intensive, it is recommended to be used only with small samples if it
is available.


The main function specifies the cluster by a \code{cluster} variable
indicating which cluster each observations belongs to.
Additionally, if the dataset is stratified, a numeric vector \code{stratum}
...
<<clus-rs-rgl-exact>>=
clusWilcox.test(x ~ grp + cluster(cid), dat.cl, method = "rgl", exact = 1)
@
...
observational stuly \citep{Ferr:Sedd:phen:2015} that aims to characterize the
...
The first 3~levels correspond to the sizd of drusen which is an
...
\caption{Empirical rejection percentage of the RGL and the DS methods
  ...
  intracluster correlation is exchangable. The results are based on
  4000 datasets. Each group contains same number of clusters.}
\begin{tabular}{ccccc rr rr rr}
  \toprule
Group & Missing & Max & Corr & Total &\multicolumn{2}{c}{$\delta = 0$} & \multicolumn{2}{c}{$\delta = 0.2$} & \multicolumn{2}{c}{$\delta = 0.5$}  \\
    \cmidrule(lr){6-7} \cmidrule(lr){8-9} \cmidrule(lr){10-11}
 level & rate & $n_i$ & $\rho$ & no. of clusters  & RGL & DS & RGL & DS & RGL & DS \\
  \midrule
cluster & 0 & 2 & 0.1, 0.1 & 40 & 4.3 & 4.5 & 16.3 & 17.0 & 64.1 & 65.2 \\
   &  &  &  & 100 & 4.7 & 4.8 & 36.5 & 37.0 & 96.4 & 96.5 \\
   &  &  &  & 200 & 4.7 & 4.8 & 65.3 & 65.5 & 100.0 & 100.0 \\
   &  &  & 0.5, 0.5 & 40 & 5.2 & 5.5 & 14.7 & 15.1 & 52.5 & 53.7 \\
   &  &  &  & 100 & 5.0 & 5.0 & 29.8 & 29.9 & 89.6 & 89.6 \\
   &  &  &  & 200 & 5.2 & 5.2 & 50.9 & 51.2 & 99.3 & 99.3 \\
   &  &  & $-$0.1, 0.9 & 40 & 5.3 & 5.5 & 14.6 & 15.3 & 59.2 & 60.2 \\
   &  &  &  & 100 & 4.8 & 4.9 & 30.6 & 30.9 & 95.0 & 95.1 \\
   &  &  &  & 200 & 5.0 & 5.0 & 56.8 & 56.9 & 99.9 & 99.9 \\
   &  & 5 & 0.1, 0.1 & 40 & 4.8 & 5.0 & 28.9 & 30.0 & 91.7 & 92.1 \\
   &  &  &  & 100 & 5.0 & 5.1 & 64.1 & 64.4 & 99.9 & 99.9 \\
   &  &  &  & 200 & 4.7 & 4.8 & 89.8 & 89.9 & 100.0 & 100.0 \\
   &  &  & 0.5, 0.5 & 40 & 5.0 & 5.5 & 16.6 & 17.4 & 64.0 & 64.8 \\
   &  &  &  & 100 & 4.7 & 4.8 & 36.6 & 37.1 & 95.6 & 95.7 \\
   &  &  &  & 200 & 4.7 & 4.7 & 60.5 & 60.7 & 99.9 & 99.9 \\
   &  &  & $-$0.1, 0.9 & 40 & 5.3 & 5.5 & 18.2 & 18.9 & 79.7 & 80.6 \\
   &  &  &  & 100 & 4.8 & 4.8 & 42.0 & 42.4 & 99.6 & 99.7 \\
   &  &  &  & 200 & 5.1 & 5.1 & 71.9 & 72.0 & 100.0 & 100.0 \\
   & 0.5 & 10 & 0.1, 0.1 & 40 & 5.7 & 6.0 & 24.6 & 28.2 & 84.3 & 89.5 \\
   &  &  &  & 100 & 4.7 & 4.8 & 58.4 & 59.1 & 100.0 & 99.9 \\
   &  &  &  & 200 & 4.9 & 5.3 & 88.7 & 87.9 & 100.0 & 100.0 \\
   &  &  & 0.5, 0.5 & 40 & 4.7 & 5.0 & 13.6 & 16.9 & 53.0 & 62.6 \\
   &  &  &  & 100 & 4.7 & 5.2 & 29.7 & 33.4 & 92.4 & 94.9 \\
   &  &  &  & 200 & 5.4 & 5.3 & 56.5 & 60.2 & 99.9 & 99.9 \\
   &  &  & $-$0.1, 0.9 & 40 & 4.8 & 4.5 & 14.1 & 16.9 & 67.5 & 77.2 \\
   &  &  &  & 100 & 4.9 & 4.8 & 36.5 & 41.2 & 99.4 & 99.5 \\
   &  &  &  & 200 & 5.6 & 5.3 & 66.1 & 68.4 & 100.0 & 100.0 \\
  subunit & 0 & 2 & 0.1, 0.1 & 40 & 5.7 & 5.8 & 18.3 & 18.5 & 69.7 & 68.6 \\
   &  &  &  & 100 & 4.7 & 4.7 & 41.2 & 41.4 & 97.6 & 97.5 \\
   &  &  &  & 200 & 4.8 & 4.8 & 69.3 & 69.2 & 100.0 & 100.0 \\
   &  &  & 0.5, 0.5 & 40 & 4.5 & 4.5 & 19.0 & 18.9 & 68.7 & 67.3 \\
   &  &  &  & 100 & 4.7 & 4.8 & 41.5 & 41.2 & 97.5 & 97.2 \\
   &  &  &  & 200 & 5.0 & 5.0 & 68.8 & 68.7 & 100.0 & 100.0 \\
   &  &  & $-$0.1, 0.9 & 40 & 4.6 & 4.9 & 19.6 & 19.2 & 70.5 & 68.2 \\
   &  &  &  & 100 & 4.6 & 4.7 & 41.3 & 40.5 & 97.5 & 97.1 \\
   &  &  &  & 200 & 4.6 & 4.7 & 67.3 & 66.8 & 100.0 & 100.0 \\
   &  & 5 & 0.1, 0.1 & 40 & 4.7 & 4.6 & 40.2 & 38.6 & 97.5 & 96.8 \\
   &  &  &  & 100 & 4.9 & 5.0 & 77.2 & 76.9 & 100.0 & 100.0 \\
   &  &  &  & 200 & 5.1 & 5.1 & 97.5 & 97.2 & 100.0 & 100.0 \\
   &  &  & 0.5, 0.5 & 40 & 5.0 & 5.0 & 43.3 & 40.5 & 97.1 & 95.7 \\
   &  &  &  & 100 & 5.3 & 5.5 & 77.4 & 75.7 & 100.0 & 100.0 \\
   &  &  &  & 200 & 4.5 & 4.5 & 96.8 & 96.8 & 100.0 & 100.0 \\
   &  &  & $-$0.1, 0.9 & 40 & 5.2 & 4.8 & 43.4 & 40.1 & 96.6 & 95.0 \\
   &  &  &  & 100 & 5.0 & 5.1 & 78.4 & 76.5 & 100.0 & 100.0 \\
   &  &  &  & 200 & 5.6 & 5.5 & 97.3 & 97.0 & 100.0 & 100.0 \\
   & 0.5 & 10 & 0.1, 0.1 & 40 & 4.9 & 5.0 & 38.3 & 35.8 & 96.5 & 94.5 \\
   &  &  &  & 100 & 4.7 & 4.3 & 76.4 & 71.5 & 100.0 & 100.0 \\
   &  &  &  & 200 & 5.2 & 5.0 & 96.7 & 94.5 & 100.0 & 100.0 \\
   &  &  & 0.5, 0.5 & 40 & 4.5 & 4.7 & 42.8 & 35.2 & 97.1 & 93.1 \\
   &  &  &  & 100 & 3.6 & 4.4 & 78.2 & 70.3 & 100.0 & 100.0 \\
   &  &  &  & 200 & 4.4 & 4.8 & 97.6 & 94.8 & 100.0 & 100.0 \\
   &  &  & $-$0.1, 0.9 & 40 & 4.5 & 4.8 & 44.9 & 34.8 & 97.4 & 92.6 \\
   &  &  &  & 100 & 4.8 & 4.7 & 79.8 & 70.4 & 100.0 & 99.9 \\
   &  &  &  & 200 & 4.9 & 4.4 & 97.1 & 93.9 & 100.0 & 100.0 \\
   \bottomrule
\end{tabular}
\label{tab:rsex}
\end{table}
...
\begin{tabular}{cccc  rr rr rr}
  \toprule
 Missing & Max & Corr & Total & \multicolumn{2}{c}{$\delta = 0$} & \multicolumn{2}{c}{$\delta = 0.2$} & \multicolumn{2}{c}{$\delta = 0.5$} \\
  \cmidrule(lr){5-6} \cmidrule(lr){7-8} \cmidrule(lr){9-10}
  rate & $n_i$ & $\rho$ &no. of clusters & RGL & DS & RGL & DS & RGL & DS \\
  \midrule
 0 & 2 & 0.1 & 40 & 5.4 & 5.6 & 19.7 & 20.4 & 78.8 & 79.0 \\
   &  &  & 100 & 5.0 & 5.1 & 44.2 & 44.4 & 99.6 & 99.6 \\
   &  &  & 200 & 4.7 & 4.7 & 73.0 & 73.1 & 100.0 & 100.0 \\
   &  & 0.5 & 40 & 5.0 & 5.3 & 15.4 & 15.8 & 68.1 & 69.0 \\
   &  &  & 100 & 5.1 & 5.2 & 34.6 & 34.9 & 97.6 & 97.7 \\
   &  &  & 200 & 5.2 & 5.2 & 60.9 & 60.9 & 100.0 & 100.0 \\
   &  & 0.9 & 40 & 5.1 & 5.4 & 13.7 & 14.1 & 56.5 & 57.4 \\
   &  &  & 100 & 4.2 & 4.2 & 29.4 & 29.8 & 93.7 & 93.8 \\
   &  &  & 200 & 4.4 & 4.5 & 51.4 & 51.6 & 100.0 & 100.0 \\
   & 10 & 0.1 & 40 & 4.4 & 4.5 & 47.2 & 47.5 & 99.6 & 99.6 \\
   &  &  & 100 & 4.6 & 4.7 & 88.0 & 88.0 & 100.0 & 100.0 \\
   &  &  & 200 & 4.7 & 4.7 & 99.5 & 99.5 & 100.0 & 100.0 \\
   &  & 0.5 & 40 & 5.0 & 5.2 & 19.7 & 20.2 & 81.4 & 81.9 \\
   &  &  & 100 & 4.8 & 4.9 & 45.2 & 45.5 & 99.6 & 99.6 \\
   &  &  & 200 & 4.7 & 4.8 & 74.7 & 74.7 & 100.0 & 100.0 \\
   &  & 0.9 & 40 & 5.0 & 5.3 & 13.6 & 14.3 & 58.9 & 59.9 \\
   &  &  & 100 & 5.1 & 5.1 & 29.4 & 30.0 & 95.0 & 95.1 \\
   &  &  & 200 & 5.1 & 5.2 & 54.6 & 54.9 & 99.9 & 99.9 \\
  0.5 & 5 & 0.1 & 40 & 4.4 & 4.8 & 21.4 & 20.2 & 82.7 & 78.3 \\
   &  &  & 100 & 5.2 & 5.0 & 50.6 & 45.3 & 99.8 & 99.5 \\
   &  &  & 200 & 5.0 & 5.0 & 80.2 & 74.8 & 100.0 & 100.0 \\
   &  & 0.5 & 40 & 4.6 & 5.2 & 15.6 & 15.7 & 67.2 & 67.1 \\
   &  &  & 100 & 4.7 & 4.8 & 36.0 & 35.2 & 97.9 & 97.5 \\
   &  &  & 200 & 4.8 & 4.7 & 62.4 & 61.8 & 100.0 & 100.0 \\
   &  & 0.9 & 40 & 4.9 & 5.2 & 14.3 & 14.8 & 58.1 & 59.3 \\
   &  &  & 100 & 4.5 & 4.7 & 27.9 & 28.1 & 93.6 & 93.7 \\
   &  &  & 200 & 4.8 & 4.9 & 49.9 & 50.3 & 99.8 & 99.8 \\
   & 10 & 0.1 & 40 & 5.2 & 5.1 & 33.1 & 31.9 & 96.9 & 96.5 \\
   &  &  & 100 & 5.1 & 5.0 & 72.3 & 69.7 & 100.0 & 100.0 \\
   &  &  & 200 & 5.3 & 5.3 & 95.7 & 94.3 & 100.0 & 100.0 \\
   &  & 0.5 & 40 & 4.3 & 4.5 & 17.7 & 18.0 & 77.7 & 77.7 \\
   &  &  & 100 & 5.1 & 5.2 & 41.3 & 41.1 & 99.3 & 99.3 \\
   &  &  & 200 & 5.5 & 5.2 & 70.8 & 70.0 & 100.0 & 100.0 \\
   &  & 0.9 & 40 & 4.5 & 4.8 & 13.1 & 13.7 & 58.1 & 59.2 \\
   &  &  & 100 & 5.1 & 5.2 & 30.0 & 30.2 & 93.9 & 93.9 \\
   &  &  & 200 & 5.1 & 5.3 & 51.1 & 51.1 & 99.9 & 99.9 \\
  \bottomrule
\end{tabular}
\label{tab:srex}
\end{table}
...
Results from selected scenarios are summarized in Table~\ref{tab:srex}.
...
\begin{tabular}{cccc  rr rr rr}
 ...
 Missing & Max & Corr & Total & \multicolumn{2}{c}{$\delta = 0$} & \multicolumn{2}{c}{$\delta = 0.2$} & \multicolumn{2}{c}{$\delta = 0.5$} \\
  ...
  rate & $n_i$ & $\rho$ &no. of clusters & RGL & DS & RGL & DS & RGL & DS \\
  \midrule
0 & 2 & 0.1 & 40 & 4.35 & 4.60 & 21.12 & 21.25 & 78.22 & 78.60 \\
   &  &  & 100 & 5.00 & 5.10 & 44.50 & 44.75 & 99.47 & 99.47 \\
   &  &  & 200 & 3.98 & 4.00 & 74.12 & 74.35 & 100.00 & 100.00 \\
   &  & 0.5 & 40 & 4.25 & 4.42 & 15.38 & 15.85 & 68.03 & 68.80 \\
   &  &  & 100 & 5.35 & 5.40 & 35.70 & 36.10 & 97.45 & 97.53 \\
   &  &  & 200 & 5.15 & 5.15 & 62.27 & 62.42 & 100.00 & 100.00 \\
   &  & 0.9 & 40 & 5.10 & 5.40 & 13.38 & 13.90 & 56.58 & 57.33 \\
   &  &  & 100 & 4.08 & 4.20 & 29.70 & 30.05 & 93.62 & 93.90 \\
   &  &  & 200 & 5.22 & 5.25 & 50.60 & 50.70 & 99.95 & 99.95 \\
   & 10 & 0.1 & 40 & 4.17 & 4.33 & 65.37 & 65.05 & 100.00 & 100.00 \\
   &  &  & 100 & 4.60 & 4.58 & 97.65 & 97.53 & 100.00 & 100.00 \\
   &  &  & 200 & 4.65 & 4.65 & 99.97 & 99.97 & 100.00 & 100.00 \\
   &  & 0.5 & 40 & 4.90 & 5.03 & 36.23 & 36.73 & 98.47 & 98.53 \\
   &  &  & 100 & 4.60 & 4.60 & 77.10 & 77.17 & 100.00 & 100.00 \\
   &  &  & 200 & 5.20 & 5.20 & 96.92 & 96.92 & 100.00 & 100.00 \\
   &  & 0.9 & 40 & 4.72 & 4.95 & 15.75 & 16.25 & 68.92 & 69.78 \\
   &  &  & 100 & 4.62 & 4.70 & 35.85 & 35.98 & 98.03 & 98.10 \\
   &  &  & 200 & 5.03 & 5.05 & 62.08 & 62.23 & 100.00 & 100.00 \\
  0.5 & 5 & 0.1 & 40 & 4.10 & 4.55 & 22.48 & 20.30 & 87.40 & 82.22 \\
   &  &  & 100 & 5.17 & 5.40 & 55.65 & 49.65 & 99.92 & 99.72 \\
   &  &  & 200 & 5.12 & 5.42 & 84.03 & 76.60 & 100.00 & 100.00 \\
   &  & 0.5 & 40 & 5.50 & 5.58 & 17.15 & 17.20 & 75.60 & 73.72 \\
   &  &  & 100 & 4.88 & 4.85 & 41.40 & 39.88 & 98.80 & 98.47 \\
   &  &  & 200 & 5.40 & 5.45 & 70.12 & 67.45 & 100.00 & 100.00 \\
   &  & 0.9 & 40 & 5.15 & 5.67 & 13.72 & 14.30 & 59.70 & 60.40 \\
   &  &  & 100 & 4.67 & 4.95 & 28.50 & 28.93 & 93.95 & 93.92 \\
   &  &  & 200 & 4.92 & 5.12 & 50.23 & 50.62 & 99.83 & 99.88 \\
   & 10 & 0.1 & 40 & 4.75 & 4.67 & 40.77 & 37.70 & 99.15 & 98.28 \\
   &  &  & 100 & 5.00 & 4.90 & 82.33 & 78.75 & 100.00 & 100.00 \\
   &  &  & 200 & 4.85 & 4.88 & 98.90 & 97.55 & 100.00 & 100.00 \\
   &  & 0.5 & 40 & 4.95 & 5.17 & 29.07 & 28.60 & 93.65 & 93.05 \\
   &  &  & 100 & 4.97 & 4.78 & 62.55 & 61.65 & 100.00 & 100.00 \\
   &  &  & 200 & 5.38 & 5.17 & 90.67 & 89.12 & 100.00 & 100.00 \\
   &  & 0.9 & 40 & 4.75 & 4.97 & 16.40 & 17.25 & 67.03 & 67.08 \\
   &  &  & 100 & 4.60 & 4.70 & 34.50 & 34.38 & 97.40 & 97.42 \\
   &  &  & 200 & 4.88 & 4.78 & 61.17 & 60.83 & 99.97 & 99.97 \\
  \bottomrule
\end{tabular}
\label{tab:srar}
\end{table}

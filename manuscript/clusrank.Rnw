...
simpower(nrep = 1000, level = 0.05, paired = FALSE, delta = 0, 
         rho = c(.1,  .1), rate = 1, nclus = 10, maxclsize = 5, "cluster")
...
<<size-clus-unbal>>=
simpower(1000, 0.05, FALSE, 0, c(.1,  .1), 0.5, 10, 5, "cluster")
simpower(1000, 0.05, FALSE, 0, c(0.9, 0.9), 0.5, 10, 5, "cluster")
@
For unbalanced data sets which are generated by randomly deleting
half of the original balanced data, the RGL method is still able to
be close to the nominal size, whereas the empirical size of DS
...
<<size-ind>>=
simpower(1000, 0.05, FALSE, 0, c(.1,  .1), 1, 10, 5, "individual")
simpower(1000, 0.05, FALSE, 0, c(0.9, 0.9), 1, 10, 5, "individual")
simpower(1000, 0.05, FALSE, 0, c(.1,  .1), 0.5, 10, 5, "individual")
...
the norminal size, whereas when the data is 
<<size-ind-20>>=
simpower(1000, 0.05, FALSE, 0, c(.1,  .1), 1, 20, 5, "individual")
simpower(1000, 0.05, FALSE, 0, c(0.9, 0.9), 1, 20, 5, "individual")
simpower(1000, 0.05, FALSE, 0, c(.1,  .1), 0.5, 20, 5, "individual")
simpower(1000, 0.05, FALSE, 0, c(0.9, 0.9), 0.5, 20, 5, "individual")
@

<<power-ind-bal>>=
simpower(1000, 0.05, FALSE, 0.5, c(.1,  .1), 1, 10, 5, "individual")
simpower(1000, 0.05, FALSE, 0.5, c(0.9, 0.9), 1, 10, 5, "individual")
@

<<power-ind-unbal>>=
simpower(1000, 0.05, FALSE, 0.5, c(.1,  .1), 0.5, 10, 5, "individual")
simpower(1000, 0.05, FALSE, 0.5, c(0.9, 0.9), 0.5, 10, 5, "individual")
@

<<power-clus-bal>>=
simpower(1000, 0.05, FALSE, 0.5, c(.1,  .1), 1, 10, 5, "cluster")
simpower(1000, 0.05, FALSE, 0.5, c(0.9, 0.9), 1, 10, 5, "cluster")
@

<<power-clus-unbal>>=
simpower(1000, 0.05, FALSE, 0.5, c(.1,  .1), 0.5, 10, 5, "cluster")
simpower(1000, 0.05, FALSE, 0.5, c(0.9, 0.9), 0.5, 10, 5, "cluster")
@
 

In both cases, the size of ``ds'' method is closer to the nominal value.

Try different values of \code{delta}.


Using \code{``cluster''}.


Nevertheless, the power of ``rgl'' method is slightly higher.

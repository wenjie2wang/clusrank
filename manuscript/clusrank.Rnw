...
In addition, if the data are stratified into $V$ strata, similar to \ref{eq:rglrs1},
$W_{RGL}$ can be expressed as 
\begin{equation*}
...
failure of the asymptotic theory of this method under this scenario.

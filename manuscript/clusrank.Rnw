...
\caption{Empirical rejection percentage of the RGL and the DS methods
  for the clustered rank-sum test at nominal significance level 0.05 with 
  data generated under exchangeable intracluster correlation. 
  The results are based on 4000 datasets. 
  Each group contains same number of clusters.}
...
\centering
\caption{Empirical rejection percentage of the RGL and the DS methods
  for the clustered rank-sum tests at nominal significance level 0.05 with
  data generated under AR1 intracluster correlation. 
  The results are based on 4000 datasets. 
  Each group contains same number of clusters.} 
\begin{tabular}{ccccc rr rr rr}
  \toprule
...
\begin{table}[tbp]
  \centering
   \caption{Empirical rejection percentage of the RGL and DS methods for
     the clustered signed-rank test at nominal significance level 0.05 with
     data generated under exchangeable intracluster correlation. 
     The results are based on 4000 datasets. 
     Each group contains same number of clusters.}
...
\begin{table}[tbp]
  \centering
   \caption{Empirical rejection percentage of the RGL and DS methods for
     the clustered signed-rank tests at nominal significance level 0.05 with
     data generated under AR1 intracluster correlation. 
     The results are based on 4000 datasets. 
     Each group contains same number of clusters.}
\begin{tabular}{cccc  rr rr rr}

...
The generated data contain \code{nclus} clusters,
...
<<size>>=
simpower(1000, 0.05, FALSE, 0, c(.9, -.1), 1, 10, 5, "individual")
simpower(1000, 0.05, FALSE, 0, c(.9,  .9), 1, 10, 5, "individual")
@
In both cases, the size of ``ds'' method is closer to the nominal value.
<<power>>=
simpower(1000, 0.05, FALSE, 1, c(.9,  -.1), 1, 10, 5, "individual")
simpower(1000, 0.05, FALSE, 1, c(.9,  .9), 1, 10, 5, "individual")
@

...
clusWilcox.test(z ~ cluster(id), data = crsd, paired = TRUE, method = "rgl", exact = TRUE, B = 0)
clusWilcox.test(z ~ cluster(id), data = crsd, paired = TRUE, method = "rgl", exact = TRUE, B = 5)
clusWilcox.test(z ~ cluster(id), data = crsd, paired = TRUE, method = "ds", exact = TRUE, B = 5)

data(crsdUnb)
clusWilcox.test(z, cluster = id, data = crsdUnb, paired = TRUE, method = "rgl")
clusWilcox.test(z, cluster = id, data = crsdUnb, paired = TRUE, method = "ds", B = 0)
clusWilcox.test(z, cluster = id, data = crsdUnb, paired = TRUE, method = "rgl", exact = TRUE, B = 0)
clusWilcox.test(z, cluster = id, data = crsdUnb, paired = TRUE, method = "rgl", exact = TRUE, B = 50)
clusWilcox.test(z, cluster = id, data = crsdUnb, paired = TRUE, method = "ds", exact = TRUE, B = 50)

data(crd)
clusWilcox.test(z ~ group + cluster(id), data = crd)
crd1 <- crd[c(1:20, 141:160), ]
clusWilcox.test(z ~ group + cluster(id), data = crd1, method = "rgl", exact = TRUE, B = 0)
clusWilcox.test(z ~ group + cluster(id), data = crd1, method = "rgl", exact = TRUE, B = 100)
...
clusWilcox.test(z ~ group + cluster(id) + stratum(stratum), data = crdStr, exact = TRUE, B = 100)
clusWilcox.test(z ~ group + cluster(id) + stratum(stratum), data = crdStr, method = "ds", exact = TRUE, B = 5)
...
clusWilcox.test(x ~ grp + cluster(cid), dat.cl, method = "rgl", exact = TRUE, B = 10)
clusWilcox.test(x, group =  grp, cluster = cid, data = dat.cl, method = "ds")
clusWilcox.test(x, group =  grp, cluster = cid, data = dat.cl, method = "ds", exact = TRUE, B = 100)
